<div class="container">
    <div class="row mb-4 pt-3 align-items-center">
        ...
        <div class="col text-end">
            <?php if($order->status === 'Em entrega'): ?>
                <a href="<?= url_to('order.received', $order->codigo)?>" class="btn btn-success">Recebido</a>
            <?php endif ?>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h2 class="card-title mb-0 fw-bold">Suas informações</h2>
        </div>
        <div class="card-body">
